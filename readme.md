...
yay -S coreutils yarn dnsutils moreutils pdftk colorpicker the_silver_searcher hyperfine wget tree ffmpeg fzf unzip xclip tig ag bat jq entr xorg-xev zoxide lsd dust  duf gping ngrok
yay -S lunar-client
